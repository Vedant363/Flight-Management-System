...
public class EmployeePortal extends FlightManagementSystem{
    ...
    EmployeePortal() throws SQLException, IOException {
        ...
        menuFrame = new JFrame("Employee Portal");
        ...
        try {
            ...
            while (resultSet.next()) {
                nameLabel = new JLabel("Hi " + resultSet.getString(1)+",");
        ...
        JLabel welcomeLabel = new JLabel("Welcome to Employee Portal");
        ...
        JButton viewEmpButton = new JButton("View Profile");
        ...
        JButton editEmpButton = new JButton("Edit profile");
        ...
        notificationLabel.setToolTipText("No new notification");
    ...
    private void updateNotificationIcon() {
        ...
        if (hasNotification) {
            ...
            notificationLabel.setToolTipText("Click to view notifications");
        } else {
            bellIcon = new ImageIcon("V:/NewFlightManagementSystem/NewFlightManagementSystem/src/bell_icon.png");
            notificationLabel.setToolTipText("No new notifications");
        }
    ...
    private void showNotifications() {
        ...
        try {
            ...
            if (flightDate != null) {
                notificationText.append("**Important Notice : \n=> New flight schedule on ").append(flightDate).append("\n");
            }
            if (notificationText.length() == 0) {
                JOptionPane.showMessageDialog(null, "No new flight schedules", "Notifications", JOptionPane.INFORMATION_MESSAGE);
            } else {
